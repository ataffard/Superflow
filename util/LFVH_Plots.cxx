...
const int n_mc_process = n_process - 1;
...
int stack_colors[] = { kAzure + 4, kRed + 1, kOrange, kSpring + 1, kYellow - 9, kGray, kMagenta - 7 };

const int n_systematics = 3;//10
string systematics[] = {
...
// const int n_fakesyst = 7;// 7
// string fake_syst[] = { "CENTRAL", "ELFR", "MUFR", "ELRE", "MURE", "ELFRAC", "MUFRAC" };

const int n_weight_syst = 3;// 10
...
vector<plot> definePlots() {
    ...
    /// // VR_LFV_Top
    /// // Plot: eventweight
    /// plot_.root_get_member = "eventweight";
    /// plot_.root_get_factor = "";
    /// plot_.signal_region = "VR_LFV_Top";
    /// plot_.request_cuts = "";
    /// plot_.blind_data = "";
    /// plot_.x_label = "eventweight";
    /// plot_.y_label = "Events";
    /// plot_.x_bin_width = 0.1;
    /// plot_.x_range_min = 0.0;
    /// plot_.x_range_max = 2.0;
    /// plot_.y_range_min = 1.0e-1;
    /// plot_.y_range_max = 1.0e9;
    /// plot_.long_name = "VR_LFV_Top_eventweight";
...
int main(int argc, char* argv[]) {
	...
	for (int r_ = 0; r_ < request_plots.size(); r_++) {
		...
		// }
        // 
		for (int p_ = 0; p_ < n_process - 1; p_++) {
